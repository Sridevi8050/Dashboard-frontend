...
export default function Admin() {
  ...
  const fetchData = async () => {
    const res = await fetch("https://dashboard-backend-q56i.onrender.com/admin/data/read");
  ...
  const createData = async () => {
    await fetch("https://dashboard-backend-q56i.onrender.com/admin/data/create", {
      method: "POST",
  ...
  const updateData = async (id) => {
    ...
    await fetch(`https://dashboard-backend-q56i.onrender.com/admin/data/update/${id}`, {
      method: "PUT",
      headers: { "Content-Type": "application/json" },
  ...
  const deleteData = async (id) => {
    await fetch(`https://dashboard-backend-q56i.onrender.com/admin/data/delete/${id}`, {
      method: "DELETE",
    });
